...
# Some problem: after you run app.py successfully, you maybe annotate lines 19 to 60 as you have already created the database, or the app.py cannot run correctly. -wayneW
import uuid
import json  
