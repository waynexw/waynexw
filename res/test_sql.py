# pre-creat the proper running environment in client-end via create new database by MySQL, kindly note that client may need to pre-install the MySQL before using this code. -wayneW
# READ ME: before running app.py, you may help yourself adjust some codes in this file, including line 22, 23, 32 and 33 line as the detailed instruction below. -wayneW
