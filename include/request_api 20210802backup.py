...
# READ ME: before run ‘py app.py‘, kindly ensure that your client has already installed the MySQL database (like mysql-installer-web-community editoin) properly, and done with the initialization process.\ 
