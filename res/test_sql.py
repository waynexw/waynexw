# pre-creat a proper environment for running app in client-end via create new database by MySQL, kindly note that client may need to pre-install the MySQL before using this code. -wayneW
# READ ME: before running app.py, you maybe help yourself adjust some codes in this file, including line 22, 23, 32 and 33 line as the detailed instruction below. -wayneW
# Some problem: after you run the app.py successfully, you may annotate/注释/ line 19 to 60 as you have already created the database, or the app.py cannot run correctly. -wayneW
