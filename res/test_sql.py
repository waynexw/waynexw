# pre-creat proper running environment in client-end via create new database by MySQL, kindly note that the client may need to pre-install the MySQL before using this code. -wayneW
