"""Endpoint to manage the BOOK_REQUESTS"""
# READ ME: before run the program by ‘py app.py‘, kindly ensure that your client has already installed the MySQL database (like mysql-installer-web-community editoin) properly, and done with the initialization process.\ 
...
# 可以加一条判断 如果数据库已经存在 则跳过此步骤,或者设置环境变量
