"""The Endpoint to manage the BOOK_REQUESTS"""
# READ ME: before run program by ‘py app.py‘, kindly ensure that your client has already installed the MySQL database (like mysql-installer-web-community editoin) properly, and done with the initialization process.\ 
